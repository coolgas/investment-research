...
**Data As Of:** May 22, 2026 close (equities, bonds, rates); May 24 close (commodities, DXY); May 25 close (GBP/USD)  
...
SPY at <span class="num">$745.64</span> is <span class="num">99.7%</span> of its 52-week high. The 10Y yield at <span class="num">4.56%</span> has risen <span class="up">+37bp</span> YTD and <span class="up">+21bp</span> since the FOMC decision. The US Dollar Index (DXY) at <span class="num">99.02</span> is up <span class="up">+0.61%</span> YTD.
...
3. **Scenario analysis** (hot-pce-scenario.md): Three-model framework for a hot May PCE downside scenario:
   ...
   - **Historical analog scaling:** Sep-Nov 2023 (10Y 4.17% to 4.99%, SPY -10.0%) used as baseline. Scaled by correlation ratio (current -0.84 divided by analog -0.49 = 1.71x multiplier).
...
4. **Data refresh** (data-refresh.md): yfinance 1.4.0 pull for 24 tickers across indices, sectors, stocks, commodities, and FX. Equities, bonds, rates as of May 22 close (Friday). Commodities and DXY as of May 24 close (Sunday). GBP/USD as of May 25 close (Monday).
...
The dollar index is at <span class="num">99.02</span>, up <span class="up">+0.61%</span> YTD and essentially flat post-FOMC (<span class="up">+0.11%</span>). The rate hold supports the USD through the interest rate differential channel — US rates remain elevated relative to most peers. However, the dollar strength is modest. This reflects the market's expectation that the Fed is at or near the peak, capping further USD upside. The combination of higher US rates and geopolitical risk from the Middle East is a classic negative setup for EM FX, with commodity importers and USD-debt-heavy EM currencies most vulnerable. Watch for EM central banks to respond with their own tightening or intervention.

### GBP/USD

Cable at <span class="num">1.3483</span>, up <span class="up">+0.05%</span> YTD and down <span class="down">-0.32%</span> post-FOMC. The modest weakness reflects the USD's incremental yield advantage. The Bank of England's own rate trajectory and UK inflation data will be the key drivers going forward.
